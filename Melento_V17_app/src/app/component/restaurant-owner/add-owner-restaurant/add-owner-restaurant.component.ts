...
@Component({
  selector: 'app-add-owner-restaurant',
  templateUrl: './add-owner-restaurant.component.html',
  styleUrls: ['./add-owner-restaurant.component.scss']
})
export class AddOwnerRestaurantComponent {
  isLinear = false;
  count=0;
  addressCount=0;
  dishCount=0;
